...
public class Ports {
  ...
  public static final CANPort kTurretHood = new CANPort(26, dynamicCanBus);
  public static final CANPort kTurretHoodEncoder = new CANPort(27, dynamicCanBus);

  public static final CANPort kTurretShooter1 = new CANPort(28, dynamicCanBus);
  public static final CANPort kTurretShooter2 = new CANPort(29, dynamicCanBus);
