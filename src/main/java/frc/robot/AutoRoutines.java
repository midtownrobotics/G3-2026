...
public class AutoRoutines {
  ...
  public AutoRoutine depotToLeftStart() {
    ...
    depotToLeftStart.active().onTrue(m_commands.shoot());
    depotToLeftStart.doneDelayed(1).onTrue(depotToLeftStart.cmd());
    depotToLeftStart.doneDelayed(0.5).onTrue(m_commands.alignTurret());
  ...
  public AutoRoutine depotToMidLeft() {
    ...
    depotToMidLeft.active().onTrue(m_commands.shoot());
    depotToMidLeft.doneDelayed(1).onTrue(depotToMidLeft.cmd());
    depotToMidLeft.doneDelayed(0.5).onTrue(m_commands.alignTurret());
