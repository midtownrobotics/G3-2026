...
public class Robot extends LoggedRobot {
  ...
  private void generateAutoChooser() {
    ...
    m_autoChooser.addRoutine("1002 Right", m_autoRoutines::copy1002right);
		...
		m_autoChooser.addRoutine("Bump Depot Middle Right", m_autoRoutines::bumpDepotMiddleRight);
		m_autoChooser.addRoutine("Trench Depot Middle Left", m_autoRoutines::trenchDepotMiddleLeft);
		m_autoChooser.addRoutine("Trench Depot Middle Right", m_autoRoutines::trenchDepotMiddleRight);
