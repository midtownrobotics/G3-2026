...
public class IntakePivot extends SubsystemBase {
  ...
  private void configureMotor() {
    ...
    config.MotionMagic
        .withMotionMagicCruiseVelocity(DegreesPerSecond.of(180).times(kMechanismToMotorGearing))
        .withMotionMagicAcceleration(DegreesPerSecondPerSecond.of(1000).times(kMechanismToMotorGearing))
