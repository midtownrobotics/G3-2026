...
public class TunerConstants {
  ...
  private static final Distance kWheelRadius = Inches.of(2.369569);
   ...
   * Only used as a reference type for IO implementations that need access to the underlying CTRE
   * swerve internals.
   */
